...
func (m *MockStore) DeleteAccount(arg0 context.Context, arg1 int64) (int32, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) DeleteEntry(arg0 context.Context, arg1 int64) (int32, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) DeleteTransfer(arg0 context.Context, arg1 int64) (int32, error) {
	m.ctrl.T.Helper()
